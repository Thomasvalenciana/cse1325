...
public class MainWin extends JFrame {
    ...
    public MainWin(String title) {
       ...
       // Add a New ELSA store icon
        JButton anewButton  = new JButton(new ImageIcon(""));
        ...
        JButton bAddComputer = new JButton(new ImageIcon("gui/resources/add_computer.png"));
          ...
          bAddOrder.setActionCommand("Insert Computer");
          bAddOrder.setToolTipText("Insert Computer");
        ...
        JButton bViewOptions = new JButton(new ImageIcon("gui/resources/view_options.png"));
          ...
          JButton bViewOrder= new JButton(new ImageIcon("gui/resources/view_order.png"));
   ...
   { 
    ...
    if (store.customers().length == 0) 
        ...
        {
            customerComboBox.addItem((Customer) c);
        }
